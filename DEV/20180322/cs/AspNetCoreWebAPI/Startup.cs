...
namespace AspNetCoreWebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(ISurveyBaseRepository), typeof(SurveyBaseSqlRepository));
            services.AddScoped(typeof(ISurveyTransactionRepository), typeof(SurveyTransactionSQLRepository));
